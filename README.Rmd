...
The mesh data is built from FreeSurfer and SUIT surfaces using scripts in `data-raw/`.
To regenerate:
...
This requires FreeSurfer (with fsaverage5) and the `freesurferformats` and `gifti` R packages.
